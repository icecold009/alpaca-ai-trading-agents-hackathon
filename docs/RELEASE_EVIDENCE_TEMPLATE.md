...
- Backend platform/region: `PENDING`
- Frontend platform/region: `PENDING`
...
- Hosted CORS/headers/log review: `PENDING`
...
Do not mark the candidate frozen while any required `PENDING` item remains unresolved. A generic “go ahead” does not authorize deployment, public posting, credential entry, or submission.
